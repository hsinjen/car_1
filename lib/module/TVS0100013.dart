...
class TVS0100013 extends StatefulWidget {
  @override
...
class _TVS0100013 extends State<TVS0100013> with TickerProviderStateMixin {
  final String moduleId = 'TVS0100013';
  final String moduleName = '新車到港作業';
  String _imageCategory = 'TVS0100013';
  ...
  void initState() {
    super.initState();
    _loadXVMS0012();
    // _inputController.text = 'JM7BN327001248206';
    portraitUp();
  }
                    ...
                    builder: (context) => FunctionMenu(
                          ...
                          onResultChange:
                            ...
                            if (value1 != null) {
                              ...
                              prefs.setStringList(
                                  'TVS0100013_SIGN', _signMaintainDataBuffer);
                              setState(() {
  ...
  void _mappingMaintain() {
    ...
    SharedPreferences.getInstance().then((prefs) {
      if (prefs.containsKey('TVS0100013_SIGN') == true)
        _signMaintainDataBuffer = prefs.getStringList('TVS0100013_SIGN');
    }).whenComplete(() {
      String vs001201 = '';
      for (Map<String, dynamic> item in _signMaintainItems) {
  ...
  Future<bool> _loadScheduleDate(String value) async {
    ...
    Datagram datagram = Datagram();
    datagram.addText("""select vsab0906 as 計劃日期
                        from (
                          select distinct vsab0906
                          from xvms_ab09
                          where vsab0911 like '%$value%' and vsab0900 = '1' and vsab0913 = 'N'
                        ) as x
        """, rowIndex: 0, rowSize: 100);
    ResponseResult result = await Business.apiExecuteDatagram(datagram);
  ...
  void _loadXVMS0012() async {
    Datagram datagram = Datagram();
    datagram.addText(
        """select 'N' as 旗標,vs001201,vs001202 from xvms_0012 where vs001200 = '1'
        """,
        rowSize: 5000);
